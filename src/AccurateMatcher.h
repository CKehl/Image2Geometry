...
private:
	...
	cv::Ptr<cv::OpponentColorDescriptorExtractor> Oextractor;
...
public:
	...
	// Set the descriptor extractor
	inline void setDescriptorExtractorOppColor(cv::Ptr<cv::OpponentColorDescriptorExtractor>& desc) { Oextractor= desc; }
	// Set the matcher
